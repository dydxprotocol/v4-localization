...
export const ERRORS_STRING_KEYS = {
    ...
    CONNECT_WALLET_TO_TRADE: 'ERRORS.TRADE_BOX_TITLE.CONNECT_WALLET_TO_TRADE',
    DEPOSIT_TO_TRADE: 'ERRORS.TRADE_BOX_TITLE.DEPOSIT_TO_TRADE',
    GEO_LOCATION_RESTRICTED: 'ERRORS.TRADE_BOX_TITLE.GEO_LOCATION_RESTRICTED',
    INVALID_GOOD_TIL: 'ERRORS.TRADE_BOX_TITLE.INVALID_GOOD_TIL',
    LIMIT_PRICE_TRIGGER_PRICE_SLIPPAGE_HIGHER: 'ERRORS.TRADE_BOX_TITLE.LIMIT_PRICE_TRIGGER_PRICE_SLIPPAGE_HIGHER',
    LIMIT_PRICE_TRIGGER_PRICE_SLIPPAGE_LOWER: 'ERRORS.TRADE_BOX_TITLE.LIMIT_PRICE_TRIGGER_PRICE_SLIPPAGE_LOWER',
    MARKET_ORDER_CLOSE_POSITION_ONLY: 'ERRORS.TRADE_BOX_TITLE.MARKET_ORDER_CLOSE_POSITION_ONLY',
    MARKET_ORDER_WARNING_INDEX_PRICE_SLIPPAGE: 'ERRORS.TRADE_BOX_TITLE.MARKET_ORDER_WARNING_INDEX_PRICE_SLIPPAGE',
    MISSING_LIMIT_PRICE: 'ERRORS.TRADE_BOX_TITLE.MISSING_LIMIT_PRICE',
    MISSING_STOP_PRICE: 'ERRORS.TRADE_BOX_TITLE.MISSING_STOP_PRICE',
    MISSING_TRADE_SIZE: 'ERRORS.TRADE_BOX_TITLE.MISSING_TRADE_SIZE',
    MISSING_TRAILING_PERCENTAGE: 'ERRORS.TRADE_BOX_TITLE.MISSING_TRAILING_PERCENTAGE',
    MISSING_TRIGGER_PRICE: 'ERRORS.TRADE_BOX_TITLE.MISSING_TRIGGER_PRICE',
    STOP_MARKET_ORDER_MAY_NOT_EXECUTE: 'ERRORS.TRADE_BOX_TITLE.STOP_MARKET_ORDER_MAY_NOT_EXECUTE',
    STOP_MUST_ABOVE_INDEX_PRICE: 'ERRORS.TRADE_BOX_TITLE.STOP_MUST_ABOVE_INDEX_PRICE',
    STOP_MUST_BELOW_INDEX_PRICE: 'ERRORS.TRADE_BOX_TITLE.STOP_MUST_BELOW_INDEX_PRICE',
    TAKE_PROFIT_MARKET_ORDER_MAY_NOT_EXECUTE: 'ERRORS.TRADE_BOX_TITLE.TAKE_PROFIT_MARKET_ORDER_MAY_NOT_EXECUTE',
